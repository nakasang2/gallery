    ...
    <main className="legal-page">
      <div className="me-inner">
        ...
        <div className="legal-body">
          ...
          <p><strong>No AI training.</strong> We do not use your works to train AI or machine-learning models, and we do not license, sell or provide them to third parties for that purpose. The hosting permission above is strictly for showing your exhibition to the visitors you invite.</p>
