...
//     カメラを動かさずに同じ結果になる。
//   - この値での実測: スマホ375で 左 -21〜93(8割見える)・中 122〜257(全部)・
//     右 295〜450(5割見える)＝3枚ともフレーム内。PC1280 では 245〜458 / 513〜779 /
//     855〜1183 で3枚とも全部見える。
//
...
const HERO_SLOTS: { idx: number; z: number; scale: number }[] = [
  ...
  { idx: 5, z: 3.5, scale: 1.35 }, // left — 3:2
  { idx: 4, z: 8.5, scale: 1.3 }, // right — 4:3（縦長だった idx 6 から差し替え）
]
