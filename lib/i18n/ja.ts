...
export const ja: Dictionary = {
  ...
  invite: {
    ...
    participantsTitle: 'この部屋の作家',
    participantsHelp: 'ハンドルで作家を招きます。出す作品は作家が選び、あなたが配置図で壁に掛けます。出されていない作品は、あなたには見えません。',
    handlePlaceholder: '@ハンドル',
    handleLabel: '作家のハンドル',
    invite: '招く',
    inviting: '招待中…',
    noParticipants: 'まだ誰も招いていません。招くまでは個展のままです。',
    openParticipants: '他の作家を招く（合同展示）',
    revoke: '外す',
    revokeConfirm: '{name} さんを外しますか？ その作家の作品はすぐにこの部屋から下ります。',
    statusPending: '招待中',
    statusDeclined: '辞退',
    ...
    errNotYours: 'その部屋にあなたが招待を出すことはできません。',
