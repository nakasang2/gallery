...
export const en = {
  ...
  invite: {
    ...
    linkHelp: 'Or share one link. Anyone who opens it can ask to join, and you confirm each one — so a link that gets passed around cannot fill your show with strangers.',
    linkCreate: 'Create an invitation link',
    linkCreateAnother: 'Create another link',
    linkCopy: 'Copy link',
    linkCopied: 'Copied',
  ...
  me: {
    ...
    markdownOk: 'Markdown works here: **bold** · *italic* · - list · [link](URL) · # heading', mdPreview: 'Preview',
