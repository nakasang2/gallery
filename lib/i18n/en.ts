...
export const en = {
  ...
  lp: {
    ...
    compareR3: 'Getting people there',
    compareR3a: 'You invite them yourself (DMs, social)',
    compareR3b: 'You invite them yourself too (share a link)',
    compareR4: 'What it asks of a visitor',
    compareR4a: 'Travel there, on the right day, at the right hour',
    compareR4b: 'Open a link',
    compareR5: 'The space itself',
    compareR5a: 'Roughly $200–$2,000 a week',
    compareR5b: 'No venue cost',
