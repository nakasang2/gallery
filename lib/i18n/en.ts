...
export const en = {
  ...
  me: {
    ...
    transferSlots: 'Move slots',
    transferSlotsIntro: "Your total slots don't change — this only moves them between your own rooms.",
    transferSlotsDestination: 'Destination room',
    transferSlotsAmount: 'How many to move (up to {max})',
    transferSlotsConfirm: 'Move',
    transferSlotsNoRooms: "You don't have another room to move slots to yet.",
    transferSlotsFailedFloor: 'This room must keep at least 1 slot.',
    transferSlotsFailedCeiling: 'The destination room cannot go over 15 slots.',
    transferSlotsFailedOther: 'Could not move the slots. Please try again.',
  ...
  help: {
    ...
    s1: 'Getting started',
    s2: 'Building your room',
    s3: 'Publishing & sharing',
    s4: 'Troubleshooting',
