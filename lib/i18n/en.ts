...
export const en = {
  ...
  lp: {
    ...
    compareR1: 'The space',
    compareR1a: 'Find a slot, book it, move the work in',
    compareR1b: 'It goes up in a browser',
    compareR2: 'How long',
    compareR2a: 'A few days to a week',
    compareR2b: 'Open until you close it',
    compareR3: 'Who can come',
    compareR3a: 'Only people who can travel there',
    compareR3b: 'Anyone who can open a link',
    compareR4: 'Afterwards',
    compareR4a: 'You take it down; records remain',
    compareR4b: 'It stays up, and you keep adding work',
