...
export const en = {
  ...
  adminUi: {
    ...
    lpHero: 'Landing page 3D ① First view (entrance)',

    lpCorridor: 'Landing page 3D ② Corridor',
    lpCorridorNote: 'The corridor visitors walk down after the entrance, in two rows. The six pitch panels come first: upload a picture and it hangs INSTEAD of the board (saying the same thing twice reads as clutter), and the wording itself comes from the dictionary. Then the seven works along the dim passage that follows, which sit behind the Concept–Pricing text. An empty panel slot leaves the board on its own; an empty passage slot keeps the built-in demo art. Landscape images sit best.',
    lpHall: 'Landing page 3D ③ Final room',
    lpHallNote: 'The big hall that comes out of the fog at the end. The three works on the front wall are the arrival point — the middle one is the largest and the most brightly lit. The four on the side walls are seen while walking in. An empty slot keeps the built-in demo art, and a very tall image is scaled down to fit between floor and ceiling.',
    lpBandPanels: 'Pitch panels (6)',
    lpBandApproach: 'Passage works (7)',
    lpBandHallFront: 'Front wall (3)',
    lpBandHallSides: 'Side walls (4)',
    lpApproach1: '01 · Right wall',
    lpApproach2: '02 · Left wall',
    lpApproach3: '03 · Right wall',
    lpApproach4: '04 · Left wall',
    lpApproach5: '05 · Right wall',
    lpApproach6: '06 · Left wall',
    lpApproach7: '07 · Right wall',
    lpHallFrontCenter: 'Front · center (largest)',
    lpHallFrontLeft: 'Front · left',
    lpHallFrontRight: 'Front · right',
    lpHallSideLeftNear: 'Left wall · near',
    lpHallSideLeftFar: 'Left wall · far',
    lpHallSideRightNear: 'Right wall · near',
    lpHallSideRightFar: 'Right wall · far',
