...
export const en = {
  ...
  adminUi: {
    ...
    roomItem: 'Extra room',
    subdomainFor: 'Exhibition subdomain',
    subdomainPlaceholder: 'tokyo-expo (.{zone})',
    subdomainInvalid: '3–40 characters: lowercase letters, digits and hyphens.',
    subdomainReserved: 'That name is reserved for infrastructure.',
    stateOpen: 'OPEN',
