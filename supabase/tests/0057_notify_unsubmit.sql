...
insert into public.artworks (id, owner_id, title, width, height, storage_path) values
  ('77000000-0000-0000-0000-0000000000c1', '77000000-0000-0000-0000-000000000001', 'Host own', 1, 1,
   '77000000-0000-0000-0000-000000000001/77000000-0000-0000-0000-0000000000c1');
reset role;
set local role authenticated;
set local "request.jwt.claim.sub" = '77000000-0000-0000-0000-000000000002';
insert into public.artworks (id, owner_id, title, width, height, storage_path) values
  ('77000000-0000-0000-0000-0000000000a1', '77000000-0000-0000-0000-000000000002', 'Work A', 1, 1,
   '77000000-0000-0000-0000-000000000002/77000000-0000-0000-0000-0000000000a1'),
  ('77000000-0000-0000-0000-0000000000a2', '77000000-0000-0000-0000-000000000002', 'Work B', 1, 1,
   '77000000-0000-0000-0000-000000000002/77000000-0000-0000-0000-0000000000a2');
reset role;
