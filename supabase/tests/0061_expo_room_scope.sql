...
insert into public.artworks (id, owner_id, title, width, height, storage_path) values
  ('61c00000-0000-0000-0000-000000000001', '61000000-0000-0000-0000-000000000001', 'W1', 100, 100, '61/w1'),
  ('61c00000-0000-0000-0000-000000000002', '61000000-0000-0000-0000-000000000001', 'W2', 100, 100, '61/w2'),
  ('61c00000-0000-0000-0000-000000000003', '61000000-0000-0000-0000-000000000001', 'W3', 100, 100, '61/w3'),
  ('61c00000-0000-0000-0000-000000000004', '61000000-0000-0000-0000-000000000001', 'W4', 100, 100, '61/w4'),
  ('61c00000-0000-0000-0000-000000000005', '61000000-0000-0000-0000-000000000001', 'W5', 100, 100, '61/w5');
...
insert into public.artworks (id, owner_id, title, width, height, storage_path, gallery_id) values
  ('61d00000-0000-0000-0000-000000000001', '61000000-0000-0000-0000-000000000001', 'EW1', 100, 100, '61/ew1',
  ...
  for i in 2..15 loop
    insert into public.artworks (id, owner_id, title, width, height, storage_path, gallery_id) values
      (('61d00000-0000-0000-0000-' || lpad(i::text, 12, '0'))::uuid,
       '61000000-0000-0000-0000-000000000001', 'EW' || i, 100, 100, '61/ew' || i,
       '61b00000-0000-0000-0000-000000000001');
  end loop;
end $$;
...
select public.__t61_state($sql$
  insert into public.artworks (id, owner_id, title, width, height, storage_path, gallery_id) values
    ('61d00016-0000-0000-0000-000000000000', '61000000-0000-0000-0000-000000000001', 'EW16', 100, 100, '61/ew16',
     '61b00000-0000-0000-0000-000000000001')
$sql$) = 'P0001';
...
select public.__t61_state($sql$
  insert into public.artworks (id, owner_id, title, width, height, storage_path, gallery_id) values
    ('61d09999-0000-0000-0000-000000000000', '61000000-0000-0000-0000-000000000001', 'Fake', 100, 100, '61/fake',
...
select public.__t61_state($sql$
  insert into public.artworks (id, owner_id, title, width, height, storage_path, gallery_id) values
    ('61d08888-0000-0000-0000-000000000000', '61000000-0000-0000-0000-000000000001', 'Fake2', 100, 100, '61/fake2',
...
insert into public.artworks (id, owner_id, title, width, height, storage_path, gallery_id) values
  ('61d0c000-0000-0000-0000-000000000001', '61000000-0000-0000-0000-000000000001', 'Orphan candidate', 100, 100,
   '61/orphan', '61b00000-0000-0000-0000-000000000003');
