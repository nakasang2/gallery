...
insert into public.artworks (id, owner_id, title, width, height, storage_path) values
  ('78000000-0000-0000-0000-0000000000c1', '78000000-0000-0000-0000-000000000001', 'Own 1', 1, 1, 'p/c1'),
  ('78000000-0000-0000-0000-0000000000c2', '78000000-0000-0000-0000-000000000001', 'Own 2', 1, 1, 'p/c2'),
  ('78000000-0000-0000-0000-0000000000c3', '78000000-0000-0000-0000-000000000001', 'Own 3', 1, 1, 'p/c3');
reset role;
set local role authenticated;
set local "request.jwt.claim.sub" = '78000000-0000-0000-0000-000000000002';
insert into public.artworks (id, owner_id, title, width, height, storage_path) values
  ('78000000-0000-0000-0000-0000000000a1', '78000000-0000-0000-0000-000000000002', 'Guest 1', 1, 1, 'p/a1');
reset role;
