...
- **最終更新**: 2026-07-23（追加FB対応: 浮かせ展示・立体キャプション・染み/ダスト白玉修正。未push）
...
## 完了ログ（直近5件）
- 2026-07-23: **追加FB対応（浮かせ展示・立体キャプション・白系アーティファクト2件）**（DECISIONS 2026-07-23参照）。作品を壁から3.5cm浮かせ疑似影を強化、キャプションを厚み付きスタンドオフプレート化、コンクリ水染みのハードエッジ矩形と至近ダストの白玉化を修正、ベンチ光を36°に絞る。devサーバー起動中の`next build`が破損原因と特定（LESSONS参照）。tsc/buildクリーン、/demo実機確認。**未push**。
